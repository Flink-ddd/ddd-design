package com.rmpl.business.api.order.clientobject.invoice;
 ...
 */
@Data
@ApiModel(description = "订单发票返回参数")
public class OrderInvoiceCO {
    ...
    private List<OrderInvoiceGoodsCO> orderInvoiceGoodsRespDTOList;
